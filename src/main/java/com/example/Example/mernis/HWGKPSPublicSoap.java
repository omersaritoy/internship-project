...
public class HWGKPSPublicSoap
{
    ...
    public HWGKPSPublicSoap()
    {
    }

    public HWGKPSPublicSoap(String url)
    {
        this.url=url;
    }

    public HWGKPSPublicSoap (String url,HWGConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        HWGRequestResultHandler handler = new HWGRequestResultHandler(HWGSoapVersion.v1_1);
        return handler;
    }
